...
// getContainerStats retrieves container stats via the Docker API.
// This works on Darwin because the Docker API is platform-agnostic -
// the actual stats come from the Linux VM running Docker Desktop.
